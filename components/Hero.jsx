        ...
        <div className="lg:flex-grow md:w-1/2 lg:pl-24 md:pl-16 flex flex-col md:items-start md:text-left items-center text-center">
          ...
          <div className="mt-5">
            <span className="inline-flex sm:ml-auto sm:mt-0 mt-4 justify-center sm:justify-start">
              <a
                href="https://github.com/aaronmagosto"
              ...
              <a
                ...
                className="ml-3 text-titanium-500 inline-flex"
                target="_blank"
                rel="noreferrer"
              >
                <img
              ...
              <a
                href="mailto:aaronagostodev@gmail.com"
                className=" text-white ml-3 inline-flex"
                target="_blank"
                rel="noreferrer"
              >
                <svg
